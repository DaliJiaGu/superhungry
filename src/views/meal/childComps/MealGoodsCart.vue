      ...
      <div class="content"> 
        <div class="content-left" @click="toggleShow"> 
          <div class="logo-wrapper">
            <div class="logo" :class="{highlight: this.$store.getters.totalCount}"> 
              <i class="iconfont icon-cart" :class="{highlight: this.$store.getters.totalCount}"></i> 
            </div> 
            <div class="num" v-if="this.$store.getters.totalCount">{{this.$store.getters.totalCount}}</div> 
          </div> 
          <div class="price" :class="{highlight: this.$store.getters.totalCount}">￥{{this.$store.getters.totalPrice}}</div>
      ...
      <transition name="move">
        ...
        <scroll class="cart-scroll" ref="cartScroll">
          <div class="list-content"> 
            <ul>
              <li class="food" v-for="(item, index) in this.$store.state.cartFoods" :key="index"> 
